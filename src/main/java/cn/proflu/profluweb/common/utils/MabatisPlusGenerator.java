...
public class MabatisPlusGenerator {
    ...
    //要生成的表名
    private static String[] tables= {"wx_order_exam"};
    //table前缀
    ...
    public static void main(String[] args) {
        ...
        gen.setPackageInfo(new PackageConfig()
                        ...
                        .setController("controller.wx")// 这里是控制器包名，默认 web
                        .setEntity("pojo.wx")
                        .setMapper("dao.wx")
                        .setService("service.wx")
                        .setServiceImpl("service.wx.impl")
                        .setXml("mappers.wx")
                        );
        ...
        fileOutList.add(new FileOutConfig("/templates/mapper.xml.ftl") {
            ...
            public String outputFile(TableInfo tableInfo) {
                return baseProjectPath + "/src/main/resources/mappers/wx/" + tableInfo.getEntityName() + "Mapper.xml";
            }
        });
